...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/api/group/{id}/invite-code/rotate": {
            "post": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dto.UnsubscribePresenceRequest"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "dto.UnsubscribePresenceRequest": {
            "type": "object",
            "properties": {
                "user_ids": {
                    "type": "array",
